...
function MovieOddPage() {
  const [movies, setMovies] = useState([]);
  const [page, setPage] = useState(1);
  const [element, setElement] = useState();

  const url = `https://api.themoviedb.org/3/movie/now_playing?api_key=07ae8877cdaf5f35409fc766524ec281&language=en-US&page=${page}`;
